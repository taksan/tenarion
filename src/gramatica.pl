...
s(ato_fala:interro_tema_desconhecido .. agente:Ag .. acao:X ..tema:incog(PronRelativo) ..desconhecido:IsDesconhecido ) -->
        ...
        sv(puxa_pron:sim ..acao:X ..tema:A ..desconhecido:IsDesconhecido),
        pontuacao_opcional(_),
	{ 
...
s(ato_fala:recusar ..agente:A ..acao:X.. tema:Tema ..desconhecido:sim ..pessoa:Pessoa) -->
	sn(coord:nao ..id:A ..pessoa:Pessoa ..tipo:_ ..produzindo:sim),
        [nao], 
	sv(puxa_pron:nao ..omite:_ ..acao:X .. tema:Tema ..pessoa: Pessoa ..desconhecido:sim),
        pontuacao_opcional('.').
...
sv(puxa_pron:sim ..omite:O ..acao:A .. tema:Agente ..desconhecido:IsDesconhecido) -->
...
sv(puxa_pron:nao ..omite:O ..acao:A .. tema:Complemento ..num:N ..pessoa:P ..desconhecido:IsDesconhecido) -->
	{ \+ compound(T); is_list(T) },
	v(omite:O ..acao:A ..subcat:[sn] ..num:N ..pessoa:P),
...
sv(puxa_pron:nao ..omite:O ..acao:A ..tema:Complemento .. num:N ..pessoa:Pess ..desconhecido:IsDesconhecido) -->
	{ \+ compound(T); is_list(T) },
...
sv(omite:O ..acao:A ..tema:(acao:AX ..pessoa:PX ..num:NX ..tema:T) ..num:N ..pessoa:P ..desconhecido:IsDesconhecido) -->
	...
	sv(puxa_pron:nao ..omite:nao ..acao:AX ..pessoa:PX ..num:NX ..tema:T ..desconhecido:IsDesconhecido).
